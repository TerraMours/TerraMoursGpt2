...
> = {
  ...
  management_completion: () => import('./management/completion/index.vue'),
  management_goods: () => import('./management/goods/index.vue'),
  management_image: () => import('./management/image/index.vue'),
  management_keyOption: () => import('./management/keyOption/index.vue'),
  management_knowledge: () => import('./management/knowledge/index.vue'),
  management_order: () => import('./management/order/index.vue'),
  management_photo: () => import('./management/photo/index.vue'),
  ...
  management_settings: () => import('./management/settings/index.vue'),
  management_user: () => import('./management/user/index.vue'),
  management_vector: () => import('./management/vector/index.vue'),
